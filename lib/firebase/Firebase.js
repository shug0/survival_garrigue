...
var FirebaseLoader = function () {
  ...
  _createClass(FirebaseLoader, [{
    ...
    key: 'addToMap',
    value: function addToMap(itemType, itemHash, itemPosition, itemRotation) {
      var newMapItem = {
        hash: itemHash,
      ...
      return this.firebase.ref('map/' + itemType).update(_defineProperty({}, newMapItemKey, newMapItem));
    }
  }, {
    key: 'getSnapMap',
